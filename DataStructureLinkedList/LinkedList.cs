...
namespace DataStructureLinkedList
{
    public class LinkedList
    {
        ...
        public void DeleteNodeAtGivenPosition(int key)
        {
            /// Finding the element index position
            int indexFound = SearchIndexKey(key);
            Node temp = head;
            Node previous = null;
            ...
            {
                /// while iterating if key not found keep incrementing and updating the pervious
                /// if key found incrementing previous
